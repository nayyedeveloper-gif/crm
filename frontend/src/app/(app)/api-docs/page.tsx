...
const ENDPOINT_GROUPS = [
  {
    ...
    items: [
      ...
      { method: 'POST', path: '/api/public/orders', note: 'Checkout / bot အော်ဒါတင်ခြင်း' },
      { method: 'GET', path: '/api/public/orders/track', note: 'Order code + phone ခြေရာခံခြင်း' },
      { method: 'POST', path: '/api/public/orders/cancel', note: 'Customer/bot cancel (confirm=true)' },
