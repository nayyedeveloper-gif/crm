...
/**
 * Telegram inline URL buttons only allow http(s).
 * This page gives an explicit tap target for tel: dial.
 */
const LOCAL = '09775630740';
const INTL = '959775630740';
const DIAL = `tel:+${INTL}`;
...
<body>
  <div class="card">
    ...
    <p>အောက်က ခလုတ်ကို <b>နှိပ်</b>ပြီး ဖုန်းခေါ်ပါ</p>
    <div class="num">${LOCAL}</div>
    <a class="btn primary" href="${DIAL}">📞 ဖုန်းခေါ်မယ်</a>
    <a class="btn secondary" href="https://shop.29jewellery.com/go/viber-pro">💬 Viber နဲ့ ဆက်သွယ်မယ်</a>
    <p class="hint">
      ခလုတ်မအလုပ်လုပ်ရင် ဖုန်းမှ <b>${LOCAL}</b> ကို တိုက်ရိုက်ခေါ်ပါ။
    </p>
  </div>
</body>
</html>`;
